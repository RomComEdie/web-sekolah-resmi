    ...
    >
      ...
      >
        <div className={`max-w-7xl mx-auto rounded-3xl sm:rounded-full transition-all duration-300 px-3 sm:px-5 py-2 flex items-center justify-between ${
          ...
          >
            <div className="w-11 h-11 sm:w-13 sm:h-13 rounded-2xl bg-white p-1 flex items-center justify-center shadow-lg border-2 border-[#c5a059] group-hover:scale-105 transition-all overflow-hidden shrink-0">
              <img src={SCHOOL_INFO.logoUrl} alt="Logo SMK Bhinneka Nusantara" className="w-full h-full object-contain drop-shadow-xs" />
            </div>
            <div>
