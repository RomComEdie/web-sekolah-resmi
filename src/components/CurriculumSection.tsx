              ...
              {filteredSubjects.map((subject) => (
                ...
                >
                  <div>
                    ...
                    {subject.image && (
                      <div className="relative aspect-[16/9] overflow-hidden bg-slate-100">
                        ...
                        <div className="absolute top-3 left-3 px-2.5 py-1 rounded-md bg-[#1b3828]/85 text-[#c5a059] text-[10px] font-mono font-bold backdrop-blur-md border border-[#c5a059]/30">
                          {subject.code}
                        </div>
                        <div className="absolute top-3 right-3 text-[11px] font-bold text-white bg-[#2d5a3f]/85 px-2.5 py-1 rounded-full border border-white/20 backdrop-blur-md">
                          {subject.grade}
                        </div>
                      </div>
                    )}
                        ...
                        <div className="space-y-1.5">
                          {subject.syllabusHighlights.map((hl, idx) => (
                            <div key={idx} className="flex items-center gap-2 text-xs text-slate-700">
                              <Check size={14} className="text-[#2d5a3f] shrink-0" />
                              <span>{hl}</span>
                            </div>
                          ))}
                        </div>
                  ...
                  <div className="px-6 pb-5 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                    ...
                    <span className="flex items-center gap-1 font-bold text-[#2d5a3f]">
                      <Clock size={13} /> {subject.weeklyHours} Jam/Minggu
                    </span>
                  </div>
                </div>
              ))}
