      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Accreditation Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#2d5a3f]/70 border border-[#c5a059]/40 text-[#f7f2e7] text-xs font-semibold backdrop-blur-sm shadow-inner">
            ...
            <p className="text-slate-300 text-base sm:text-lg max-w-2xl font-normal leading-relaxed">
              Selamat datang di portal resmi <strong className="text-white font-semibold">SMK Nusa Bangsa</strong>. 
            ...
            >
              ...
              <div className="relative rounded-xl overflow-hidden aspect-[4/3] group">
                ...
                <div className="absolute bottom-4 left-4 right-4 p-3.5 rounded-xl bg-[#1b3828]/85 backdrop-blur-md border border-[#c5a059]/30">
                  ...
                  <div className="text-sm font-semibold text-white mt-0.5">SMK Nusa Bangsa Kota Sejahtera</div>
