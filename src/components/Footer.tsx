    ...
    <footer className="bg-[#1b3828] text-white border-t border-[#2d5a3f]/40 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-[#2d5a3f]">
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-300">
              ...
              <li>
                <button onClick={() => onNavigate('ppdb')} className="hover:text-white transition-colors">
                  Daftar PPDB/MPLS
                </button>
              </li>
            </ul>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          <div>
            &copy; {new Date().getFullYear()} SMK Nusa Bangsa. All Rights Reserved. Portal Resmi Pendaftaran & Profil Sekolah.
          </div>
