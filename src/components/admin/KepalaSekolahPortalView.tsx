      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-64 bg-[#0d1a13] border-r border-[#264432] flex flex-col shrink-0 hidden md:flex">
          ...
          <div className="p-5 border-b border-[#264432] flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[#c5a059] to-[#8d7037] text-[#0d1a13] font-black flex items-center justify-center shadow-lg border border-[#e8cb90]/40 shrink-0">
              <Crown size={22} />
            </div>
            <div>
        ...
        <main className="flex-1 flex flex-col min-w-0 bg-[#f4f7f5] text-slate-800 overflow-y-auto">
          ...
          {/* Top Bar */}
          <header className="bg-white border-b border-slate-200 px-6 py-4 sticky top-0 z-20 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <h2 className="text-lg font-black text-[#1b3828] tracking-tight mt-0.5 flex items-center gap-2">
